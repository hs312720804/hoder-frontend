...
export function get_office_tree_json(params){
    return fetch({
        method: 'get',
        url: '/api/manage/office/get_office_tree_json',
        params 
      })
}
...
export function batchDelUsers(data){
    return fetch({
        method: 'POST',
        url: '/api/manage/user/batchDel',
        data 
      })
}
...
/** 修改人员状态*/
export function changeloginFlag(data){
    return fetch({
        method: 'POST',
        url: '/api/manage/user/changeStatus',
        data 
      })
}