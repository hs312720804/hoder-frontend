...
import effectDataStatus from '@/views/launch/LaunchStatus'
...
const children = [
  ...
  {
    name: 'effectDataStatus',
    path: '/launchHelper/effect-data-status',
    component: effectDataStatus,
    meta: {
      title: '效果数据状态',
      tagId: 'effectDataStatus ',
      icon: 'el-icon-cc-file'
    }
  },
  {
    name: 'dataManage',
    path: '/developer-tool/dataManage',
    component: dataMange,
    meta: {
      tagId: 'dataManage',
      title: '人群位置信息管理',
  ...
  {
    name: 'thirdInterface',
    path: '/developer-tool/thirdInterface',
  ...
  {
    name: 'clearCache',
    path: '/developer-tool/clearCache',
...
export default function createRoutes (frameRoutes = []) {
  frameRoutes = frameRoutes.concat(children)
  return frameRoutes
}
