    ...
    <div v-if="tags && tags.length > 0">
      ...
      <div class="label-or">
        <div
          ...
          v-if="tags.length"
          :style="{
            'padding-top': crowd.rulesJson.rules.length > 0 ? '10px' : 0,
          }"
        >
          <el-tag
            class="oc-item"
    ...
    <div v-if="specialTags && specialTags.length > 0">
        ...
        <div class="label-ground" :key="index">
          <div class="tag-condition--parent">
            ...
            >
              ...
              <span
                class="i"
                @click="handleRemoveSpecialRule(crowd, item, childItem)"
              >
                <i class="icon iconfont el-icon-cc-delete"></i>
              </span>
            </div>
            <div class="label-add">
              <div class="optional-condition">
                <el-tag
                  ...
                  @click.native="
                    handleAddSpecialChildRule(crowd, item, tagItem)
                  "
                  :type="dataSourceColorEnum[tagItem.dataSource]"
                  >{{ tagItem.tagName }}</el-tag
                >
      ...
      <div class="label-or">
        <div
          ...
          :style="{
            'padding-top':
              crowd.dynamicPolicyJson.rules.length > 0 ? '10px' : 0,
          }"
        >
          <el-tag
            class="oc-item"
...
export default {
  ...
  created() {
    ...
    if (this.crowd.rulesJson.rules.length > 0) {
      let ruleJsonData = this.crowd.rulesJson
      let cacheIds = []
      let cacheSpecialIds = []
