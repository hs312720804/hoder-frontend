      ...
      <template v-for="(item, index) in dynamicPolicyJson.rules">
        <div class="label-ground" :key="index">
          <div class="tag-condition--parent">
            ...
            >
              <template v-if="childItem.type === 'one'">
                <div class="flex-item">
                  <el-select
                  ...
                  >
                    ...
                    <el-option label="最近时间" :value="2"></el-option>
                  </el-select>
                </div>
                <div class="flex-item" v-if="childItem.dynamic.type === 2">
                  <el-input
                ...
                <div class="flex-item">
                  <el-select
                    ...
                    style="width: 120px"
                  >
                    <el-option label="观看" :value="1"></el-option>
                ...
                <div class="flex-item">
                  <el-select
                    v-model="tvValue"
                    style="width: 120px"
                    placeholder="请输入视频名称或ID搜索"
                  >
                    <el-option label="赘婿" :value="1"></el-option>
                    <el-option label="司藤" :value="2"></el-option>
                    <el-option label="战狼" :value="3"></el-option>
                  </el-select>
                  <!-- <el-select
              ...
              <template v-if="childItem.type === 'two'">
                <div class="flex-item">
                  ...
                  >
                    ...
                    <el-option label="单次时长" :value="2"></el-option>
                    <el-option label="次数" :value="3"></el-option>
                    <el-option label="总时长" :value="4"></el-option>
                  </el-select>
                </div>
                <span >
                  <el-select
