<template>
    <el-dialog :visible.sync="showAddForm" title="请上传MAC包" @close="$emit('close-add')">
        <el-form :model="form" ref="addForm" :rules="addFormRule">
    ...
    export default {
        ...
        methods : {
            handleSelectFile(event) {
                ...
                this.$service.devicePortraitFileUpload(formData,'文件上传成功').then(data=> {
