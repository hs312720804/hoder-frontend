  ...
  <el-card shadow="never">
    <div slot="header" v-if="!showSelection">
      ...
      <el-form :inline="true" style="float: right">
        <el-form-item>
          <el-input clearable @keyup.enter.native="fetchData" v-model="filter.launchName"
            placeholder="支持人群名、ID搜索"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="fetchData">查询</el-button>
          <el-button type="primary" @click="openAddDialog" v-permission="'hoder:label:attr:add'">
            新建属性
          </el-button>
    ...
    <div>
      <el-table ref="changeTable" :data="itemList" border @select="handleSelectOrCancel"
        ...
        <el-table-column v-if="!showSelection" label="操作" width="200">
          <template slot-scope="scope">
            <el-button-group>
              ...
              <el-button size="small" type="text" v-permission="'hoder:label:attr:del'"
                @click="handleDeleteTag(scope.row)">
                删除
              </el-button>
              <el-button size="small" type="text" @click="handleMonitor(scope.row)"
    ...
    <el-pagination class="pagination" :current-page="pagination.pageNum" :page-size="pagination.pageSize"
      :total="pagination.total" @size-change="fetchData" @current-change="fetchData" :page-sizes="[10, 20, 50, 100]"
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="700px">
      <el-form :model="attrForm" :rules="attrFormRules" ref="attrFormRef" label-width="80px">
        <el-form-item label="属性名称" prop="launchName">
          <el-input size="small" v-model="attrForm.launchName" :maxlength="50"></el-input>
        </el-form-item>
        <el-form-item label="SQL语句" prop="crowdSql">
          <el-input type="textarea" placeholder="请输入生成样本数据的sql语句" v-model="attrForm.crowdSql">
          </el-input>
        </el-form-item>
      </el-form>
