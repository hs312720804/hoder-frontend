<template>
    <div>
        ...
        <!--新增界面-->
        <el-dialog :title="dialogTitle" :visible.sync="addFormVisible" v-if="addFormVisible" v-model="addFormVisible" :close-on-click-modal="false">
