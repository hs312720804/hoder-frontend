    ...
    <div >
      ...
      <div class="wrap-div">
        ...
        <div class="chart-wrap">
          <div :id="crowdId+'chart1'" :ref="crowdId+'chart1'" class="chart-1" >chart1</div>
        </div>
      </div>
    </div>
                  ...
                  <div class="unit-box" >
                    ...
                    <div class="unit-header clearfix">
                      ...
                      <el-radio-group v-model="radioType2"
                        v-if="key === crowdId + '_payPopulationTrendOfEachCard' || key === crowdId + '_payAmountTrendOfEachCard'"
                        class="radio-type">
